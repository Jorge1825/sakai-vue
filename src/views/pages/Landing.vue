        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            <div id="hero" class="flex flex-col pt-6 px-6 lg:px-20 overflow-hidden"
                ...
                <div class="mx-6 md:mx-20 mt-0 md:mt-6">
                    <h1 class="text-6xl font-bold text-gray-900 leading-tight"><span class="font-light block">SOSTENIWEB
                        </span>Tu mejor alternativa</h1>
                    <p class="font-normal text-2xl leading-normal md:mt-4 text-gray-700">Te facilitamos el crecimiento
                        de tu negocio de manera sostenible.
                    </p>
                    <Button label="Empezar" as="router-link" to="/" rounded class="!text-xl mt-8 !px-4"></Button>
                </div>
                ...
                <div class="grid grid-cols-12 gap-4 justify-between mt-20 md:mt-0">
                    <div class="col-span-12 lg:col-span-4 p-0 md:p-4">
                        <div class="p-4 flex flex-col border-surface-200 dark:border-surface-600 pricing-card cursor-pointer border-2 hover:border-primary duration-300 transition-all"
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-center my-8 text-3xl">Plan Basico
                            </div>
                            <img src="/demo/images/landing/free.svg" class="w-10/12 mx-auto" alt="free" />
                            <div class="my-8 flex flex-col items-center gap-4">
                                <div class="flex items-center">
                                    <span class="text-5xl font-bold mr-2 text-surface-900 dark:text-surface-0">$-</span>
                            ...
                            <ul class="my-8 list-none p-0 flex text-surface-900 dark:text-surface-0 flex-col px-8">
                                <li class="py-2">
                                    ...
                                    <span class="text-xl leading-normal">--------</span>
                                </li>
                                <li class="py-2">
                                    <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>
                                    <span class="text-xl leading-normal">--------</span>
                    ...
                    <div class="col-span-12 lg:col-span-4 p-0 md:p-4 mt-6 md:mt-0">
                        <div class="p-4 flex flex-col border-surface-200 dark:border-surface-600 pricing-card cursor-pointer border-2 hover:border-primary duration-300 transition-all"
                            style="border-radius: 10px">
                            <div class="text-surface-900 dark:text-surface-0 text-center my-8 text-3xl">Plan Premium
                            </div>
                    ...
                    <div class="col-span-12 lg:col-span-4 p-0 md:p-4 mt-6 md:mt-0">
                        <div class="p-4 flex flex-col border-surface-200 dark:border-surface-600 pricing-card cursor-pointer border-2 hover:border-primary duration-300 transition-all"
                            style="border-radius: 10px">
                            <div class="text-surface-900 dark:text-surface-0 text-center my-8 text-3xl">Plan Corporativo
                            </div>
