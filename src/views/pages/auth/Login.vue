                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <q-form @submit.prevent.stop="signIn" novalidate>
                        ...
                        <div class="flex justify-between mt-2 mb-8 gap-8">
                            ...
                            <span class="forgot-password" @click="showRecoverPasswordModal = true"> ¿Olvidaste la contraseña? </span>
                        </div>
                        <q-btn style="background-color: rgb(4, 178, 217); color: white" label="Ingresar" class="w-full" type="submit" />
                    </q-form>
                </div>
            </div>
        </div>
