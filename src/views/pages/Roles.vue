...
async function saveRole() {
    ...
    if (role.value._id) {
        ...
        if (response.status <= 300) {
            ...
            Notify.create({ message: 'Error al actualizar el rol.', type: 'negative', position: 'top', textColor: 'white', color: 'rgb(242, 185, 179)', multiLine: true });
        }
    } else {
        const roleApi = {
            name: role.value.name,
        ...
        if (response.status <= 300) {
            ...
            Notify.create({ message: 'Error al crear el rol.', type: 'negative', position: 'top', textColor: 'white', color: 'rgb(242, 185, 179)', multiLine: true });
        }
    }
}
    ...
    try {
        ...
        if (response.status <= 300) {
            ...
            Notify.create({
                ...
                position: 'top',
                textColor: 'white',
                color: selectedRole.status === 'Activo' ? 'blue' : 'rgb(242, 185, 179)', //rgb(4, 178, 217)
                multiLine: true
            });
