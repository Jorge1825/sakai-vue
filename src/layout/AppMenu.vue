...
const itemsFull = [
            ...
            { label: 'Evaluaciones Express', icon: 'pi pi-fw pi-cog', to: '/express', users: ['ADMIN', 'SUPERADMIN', 'USER'], orderAdmin: 5, orderUser: 2 },
            ...
            { label: 'Diagnostico', icon: 'pi pi-fw pi-cog', to: '/diagnostic', users: ['USER', 'ADMIN', 'SUPERADMIN'], orderAdmin: 13, orderUser: 4 }
