 ...
 */
export function notifySuccess({ message, position = 'top', textColor = 'white', color = 'blue', multiLine = true }) {
 ...
 * @param {NotificationConfig} config - La configuración de la notificación.
 */
export function notifyError({ message, position = 'top', textColor = 'white', color = 'rgb(242, 185, 179)', multiLine = true }) {
